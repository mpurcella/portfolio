			...
			<Wrapper>
				...
				<div className='about-info'>
					<SectionText sectionTextClassName='section-text about-text'>
						I'm Mike, a Front-end Web Developer located in Portland, Oregon. My coding experience began long
						ago when I started "hacking" custom backgrounds and songs into my Myspace profile. It wasn't
						until later in life that I decided to pursue a career in it...Web development, that&nbsp;is.
						<br />
						<br />
